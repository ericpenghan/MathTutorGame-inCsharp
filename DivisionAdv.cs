...
namespace MathTutor
{
    public class DivisionAdv
    {
        ...
        public virtual int GetNum1()//generate num1 and other class can modify it 
        {
            ...
            int number1 = rnd.Next(0, 50);//generate a number between 0 and 50
            return number1;
        }
        ...
        {
            Random rnd = new Random();//declare random object 
            int number2 = num1 * (rnd.Next(0, 50));//generate a number between 0 and 50 and divisiable by the precious number
            return number2;
        }
